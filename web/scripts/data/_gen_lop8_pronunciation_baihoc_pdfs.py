#!/usr/bin/env python3
"""Extract 6 page images from Pronuncation_Baihoc_Lop8.docx → JPGs + 1-page PDFs.

Usage (from web/):
  python scripts/data/_gen_lop8_pronunciation_baihoc_pdfs.py
  python scripts/data/_gen_lop8_pronunciation_baihoc_pdfs.py --docx "E:/.../Pronuncation_Baihoc_Lop8.docx"
"""
...
OUT_DIR = HERE / "pronunciation-baihoc-lop8"
PDF_DIR = OUT_DIR / "pdfs"

DEFAULT_DOCX_CANDIDATES = [
    Path(r"E:\Wewin\Game Trắc Nghiệm\PDF\Pronuncation_Baihoc_Lop8.docx"),
    HERE.parents[3] / "PDF" / "Pronuncation_Baihoc_Lop8.docx",
    Path.cwd().parents[2] / "PDF" / "Pronuncation_Baihoc_Lop8.docx",
]
...
def find_docx(explicit: str | None) -> Path:
    ...
    raise FileNotFoundError(
        "Pronuncation_Baihoc_Lop8.docx not found — pass --docx PATH"
    )
...
def main() -> None:
    ...
    combined = PDF_DIR / "Pronunciation_Baihoc_Lop8.pdf"
