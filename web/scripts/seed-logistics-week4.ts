/**
 * Seed Logistics Week 4 courses + attach PDF ebooks.
 *
 * PDF order: L1 Commute → L1 Directions → L2 Directions → L2 Transport.
...
const PDF_DIR =
  process.env.LOGISTICS_WEEK4_PDF_DIR ||
  'E:/Wewin/Wewin-Education-main/anh_wewin/flyer/unit 7/Castle & Environment';

type Week4Seed = LogisticsCourseSeed & { pdfFileName: string };

const WEEK4_SEEDS: Week4Seed[] = [
  {
    ...LOGISTICS_WEEK4_COURSES[0],
    pdfFileName: 'Level 1 Transportation & Daily Commute.pdf',
  },
  {
    ...LOGISTICS_WEEK4_COURSES[1],
    pdfFileName: 'Daily Life - Asking and Giving Directions.pdf',
  },
  {
    ...LOGISTICS_WEEK4_COURSES[2],
    pdfFileName: 'Daily Life Directions Level 2- SESSION 7.pdf',
  },
  {
    ...LOGISTICS_WEEK4_COURSES[3],
    pdfFileName: 'Daily Life - Transportation & Commute - Level 2 - Sesson 8.pdf',
  },
];
...
async function ensureCourse(seed: Week4Seed, ebookId: string, pageCount: number) {
