/**
 * Replace Week 3 scramble + pronunciation questions from curated vocab decks.
 *
 * Usage:
 *   node scripts/run-with-env.mjs local -- npx tsx scripts/seed-logistics-week3-vocab-games.ts
 *   node scripts/run-with-env.mjs neon -- npx tsx scripts/seed-logistics-week3-vocab-games.ts
 */
import '../lib/loadEnv';
...
async function main() {
  for (const seed of LOGISTICS_WEEK3_COURSES) {
