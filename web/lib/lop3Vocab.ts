...
export const LOP3_UNIT_VOCAB: Record<number, Lop3UnitVocab> = {
  1: {
    ...
    words: [
      ...
      { word: 'goodbye', hint: 'tạm biệt', ipa: '/ɡʊˈdbaɪ/' },
      ...
      { word: 'afternoon', hint: 'buổi chiều', ipa: '/æftɜːˈnuːn/' },
    ],
  },
  2: {
    unit: 2,
    ...
    words: [
      ...
      { word: 'names', hint: 'những cái tên', ipa: '/neɪmz/' },
  ...
  7: {
    ...
    words: [
      ...
      { word: 'stand up', hint: 'đứng lên', ipa: '/stænd ʌp/' },
  ...
  18: {
    ...
    words: [
      ...
      { word: 'look at', hint: 'nhìn', ipa: '/lʊk æt/' },
      { word: 'in/on/under', hint: 'trong / trên / dưới', ipa: '/ɪn/ɒn/ˈʌndə(r)/' },
      { word: 'activity', hint: 'hoạt động', ipa: '/æˈktɪvʌtiː/' },
    ],
  },
  19: {
    unit: 19,
